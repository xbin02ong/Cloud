...
namespace Assignment.Elearning1
{
    public partial class WebService : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Check for cache URL
            String URIcache = File.ReadAllText("C:/Users/Xinbin/Desktop/Cloud/URIcache.txt");
            ...
            if (String.Compare(URIcache, url.ToString()) == 0)
            {
                ...
                wsResponseXmlDoc.Load("C:/Users/Xinbin/Desktop/Cloud/WebServiceCache.xml");
            ...
            for (NumberofError = 0; NumberofError < 3; NumberofError++) {
                ...
                if (wsResponseXmlDoc == null)
                {
                    ...
                    wsResponseXmlDoc = new XmlDocument();
                    wsResponseXmlDoc.Load("C:/Users/Xinbin/Desktop/Cloud/WebService.xml");
                ...
                else
                {
                    ...
                    String filePath = "C:/Users/Xinbin/Desktop/Cloud";
                    File.WriteAllText(filePath + @"/URIcache.txt", url.ToString());

 
                    wsResponseXmlDoc.Save("C:/Users/Xinbin/Desktop/Cloud/WebServiceCache.xml");
